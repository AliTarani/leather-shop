...
const ProductPage = () => {
  ...
  // const initialProductPromise: Promise<Product[]> = searchProducts(
  //   products,
  //   ""
  // );
  // const [productsPromise, setProductsPromise] = useState(initialProductPromise);
  // const filteredProducts = use(productsPromise);
  ...
  useEffect(() => {
    searchProducts(products, "").then((res) => {
      setFilteredProducts(res);
    });
  }, [products]);

  return (
    <Suspense fallback="لطفا منتظر بمانید">
      <div
        ...
        <div className="mb-6 max-w-lg mx-auto">
          <input
            ...
            onChange={(e) => {
              ...
              startTransition(() => {
                searchProducts(products, e.target.value).then((res) => {
                  setFilteredProducts(res);
                });
              });
            }}
